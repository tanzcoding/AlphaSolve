...
ORCHESTRATOR_CONFIG = {**LONGCAT_CONFIG}   # 编排器默认使用 LongCat
```

支持的预置：`DEEPSEEK_CONFIG`、`VOLCANO_CONFIG`、`MOONSHOT_CONFIG`、`DASHSCOPE_CONFIG`、`LONGCAT_CONFIG`、`PARASAIL_CONFIG`、`OPENROUTER_CONFIG`、`MIMO_CONFIG`
