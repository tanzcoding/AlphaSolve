...
- Check each row for missing hypotheses, domain changes, hidden regularity assumptions, invalid quantifier shifts, circularity, and misuse of stated premises.
