...
# AlphaSolve 包根目录（用于定位 prompts 等内置资源）
PACKAGE_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
from alphasolve.llms.tools import (
    PROOF_SUBAGENT_TOOL,
...
class AlphaSolveConfig:
    ...
    GENERATOR_PROMPT_PATH = os.path.join(PACKAGE_ROOT, 'prompts', 'generator.md')
    ...
    VERIFIER_PROMPT_PATH = os.path.join(PACKAGE_ROOT, 'prompts', 'verifier.md')
    ...
    REVISER_PROMPT_PATH = os.path.join(PACKAGE_ROOT, 'prompts', 'reviser.md')
    ...
    SUMMARIZER_PROMPT_PATH = os.path.join(PACKAGE_ROOT, 'prompts', 'summarizer.md')
